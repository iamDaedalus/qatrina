...
async function render() {
  ...
  if (hash.startsWith("company/")) {
    content = `<div id="companyContainer">
    <div id="companyLanding"></div>
    <div id="companyWrapper"></div>
    </div>`;
  }
  if (hash.startsWith("networks/")) {
    content = `<div id="networkContainer">
     <div id="networkLanding"></div>
    <div id="networkWrapper"></div>
    </div>`;
